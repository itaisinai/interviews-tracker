...
import { createGmailAuthUrl, disconnectGmail, getGmailStatus, listAllIgnoredGmailMessages, unignoreGmailMessage } from "../services/gmail/gmail-service.js";
...
gmailRouter.get("/ignored-messages", asyncHandler(async (request, response) => {
...
gmailRouter.delete("/ignored-messages/:messageId", asyncHandler(async (request, response) => {
