...
test("overdue interactions before a later rejection keep their historical status", () => {
  const interactions = [
    {
      id: "interaction-a",
...
test("overdue interactions without a later terminal state become needs follow-up", () => {
  const interactions = [
    {
      id: "interaction-a",
      jobOpportunityId: "opportunity-1",
