...
test("global search groups companies, opportunities, and interactions", () => {
  const results = buildGlobalSearchResults({ companies: [company], opportunities: [opportunity], interactions, query: "ree" });
...
test("global search suppresses empty and very short queries", () => {
  const results = buildGlobalSearchResults({ companies: [company], opportunities: [opportunity], interactions, query: "r" });
...
test("no-results query returns empty grouped collections", () => {
  const results = buildGlobalSearchResults({ companies: [company], opportunities: [opportunity], interactions, query: "xyz" });
