  ...
  return (
    <div className="mt-6 rounded-2xl border border-outline-variant bg-surface-container-low p-5">
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <EditableDetail label="Company title" value={research.companyName} editing={editingField === "companyName"} onEdit={() => onEditField("companyName")} onDone={() => onEditField(null)} onChange={(value) => onUpdateField("companyName", value || companyName)} status={diffStatus(companyName, research.companyName)} />
