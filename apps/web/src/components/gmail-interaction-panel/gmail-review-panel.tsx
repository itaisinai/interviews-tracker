          ...
          {opportunityInteractions.length ? (
            <label className="mt-4 block space-y-1">
              ...
              <select
                ...
                onChange={(event) => onAttachTargetIdChange(event.target.value)}
              >
          ...
          <Field label="Type" changed={changedInteractionFields.has("type")}>
            <select
              ...
              onChange={(event) =>
                onDraftChange({
                  ...draft,
                  type: event.target.value as GmailInteractionDraft["type"],
                })
              }
            >
          ...
          >
            <select
              ...
              onChange={(event) =>
                onDraftChange({
                  ...draft,
                  status: event.target.value as GmailInteractionDraft["status"],
                })
              }
            >
          ...
          >
            <input
              ...
              onChange={(event) =>
                onDraftChange({
                  ...draft,
                  personName: event.target.value || null,
                })
              }
            />
          </Field>
          ...
          >
            <input
              ...
              onChange={(event) =>
                onDraftChange({
                  ...draft,
                  personRole: event.target.value || null,
                })
              }
            />
          </Field>
          ...
          >
            <input
              ...
              onChange={(event) =>
                onDraftChange({
                  ...draft,
                  meetingLink: event.target.value || null,
                })
              }
            />
          </Field>
          ...
          >
            <textarea
              ...
              onChange={(event) =>
                onDraftChange({
                  ...draft,
                  followUp: event.target.value || null,
                })
              }
            />
          </Field>
