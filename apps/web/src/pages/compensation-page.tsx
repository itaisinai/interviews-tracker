...
export function CompensationPage() {
  ...
  const { data = [] } = useQuery({ queryKey: ["compensation"], queryFn: api.compensation });
  ...
  return (
    <>
      <PageIntro title="Compensation" description="Track offer details, negotiation notes, and decision status." />
