...
export const api = {
  ...
  attachEmailToInteraction: (interactionSlug: string, gmailMessageId: string) => request<{ id: string; interactionId: string; gmailMessageId: string; subject: string | null; from: string | null; receivedDate: string | null; extractedData: unknown; attachedAt: string }>(`/interactions/${interactionSlug}/emails`, { method: "POST", body: JSON.stringify({ gmailMessageId }) }),
  attachMultipleEmailsToInteraction: (interactionSlug: string, gmailMessageIds: string[]) => request<{ attachedEmails: Array<{ id: string; interactionId: string; gmailMessageId: string; subject: string | null; from: string | null; receivedDate: string | null; extractedData: unknown; attachedAt: string }> }>(`/interactions/${interactionSlug}/emails`, { method: "POST", body: JSON.stringify({ gmailMessageIds }) }),
