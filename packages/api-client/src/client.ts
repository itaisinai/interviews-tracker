...
export const api = {
  ...
  gmailMessageStates: (id: string) => request<{ removedEmails: Array<{ id: string; subject: string; date: string }>; pickedEmails: Array<{ id: string; subject: string; date: string }>; ignoredEmails: Array<{ id: string; subject: string; date: string }> }>(`/opportunities/${id}/gmail/message-states`),
  gmailParseEmail: (id: string, body: { messageId?: string; messageIds?: string[] }) => request<GmailParsedEmailResponse>(`/opportunities/${id}/gmail/parse-email`, { method: "POST", body: JSON.stringify(body) }),
  ...
  gmailIgnoreEmail: (id: string, messageId: string) => request<void>(`/opportunities/${id}/gmail/messages/${encodeURIComponent(messageId)}/ignore`, { method: "POST" }),
  gmailUnignoreEmail: (id: string, messageId: string) => request<void>(`/opportunities/${id}/gmail/messages/${encodeURIComponent(messageId)}/ignore`, { method: "DELETE" }),
  ...
  updatePerson: (personId: string, body: { name?: string; email?: string; linkedinUrl?: string; title?: string; company?: string; avatarUrl?: string }) => request<{ id: string; name: string; email: string | null; linkedinUrl: string | null; title: string | null; company: string | null; avatarUrl: string | null; research: unknown }>(`/people/${personId}`, { method: "PUT", body: JSON.stringify(body) }),
  ...
  parseCurrentJob: (personId: string, jobDescriptionText: string) => request<{ parsedJob: unknown; updatedTimeline: unknown; currentTimeline: unknown }>(`/people/${personId}/parse-current-job`, { method: "POST", body: JSON.stringify({ jobDescriptionText }) }),
  applyJobUpdate: (personId: string, updatedTimeline: unknown) => request<unknown>(`/people/${personId}/apply-job-update`, { method: "POST", body: JSON.stringify({ updatedTimeline }) }),
