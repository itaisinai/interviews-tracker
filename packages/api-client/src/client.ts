...
export const api = {
  ...
  createPerson: (body: { name: string; email?: string; linkedinUrl?: string; title?: string; company?: string; avatarUrl?: string }) => request<{ id: string; name: string; email: string | null; linkedinUrl: string | null; title: string | null; company: string | null; avatarUrl: string | null; research: unknown }>("/people", { method: "POST", body: JSON.stringify(body) }),
